...
<?php
	...
	try {
		...
		$sql = "select  numero,nom,prenom,ville from Client as c inner join Participer as p on c.numero = p.numeroClt where numeroAte = '$numero'";
                    ...
                    <tbody>
                        ...
                        <?php foreach( $stagiaire as $unStagiaire ){ ?>
                            <tr>
                                ...
                                <td><?php echo $unStagiaire[ "nom" ] ; ?></td>
                                <td><?php echo $unStagiaire[ "prenom" ] ; ?></td>
                                <td><?php echo $unStagiaire[ "ville" ] ; ?></td>
                            </tr>
                        <?php } ?>
